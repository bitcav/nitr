...
# nitr-agent
nitr-agent is a crossplatform remote monitoring tool written in Golang. 
Works providing system and hardware information through a JSON APIproviding system and hardware information through a JSON API.
